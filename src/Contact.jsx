    ...
    return (
        <div className="flex h-340 flex-col items-center">
            ...
            <div className="flex flex-wrap my-20 h-60 w-180 items-center justify-evenly border-white bg-amber-50 rounded-[50%] hover:scale-120 duration-300 fade">
                ...
                <a href="https://cornhub.website/#google_vignette"><img src={mailsvg} alt="GitHub Logo" className="h-15 w-15 cursor-pointer opacity-65 hover:opacity-100 hover:-translate-y-2 duration-300"/></a>
                <a href="https://cornhub.website/#google_vignette"><img src={telesvg} alt="GitHub Logo" className="h-15 w-15 cursor-pointer opacity-65 hover:opacity-100 hover:-translate-y-2 duration-300"/></a>
                <a href="https://cornhub.website/#google_vignette"><img src={linkedinsvg} alt="GitHub Logo" className="h-15 w-15 cursor-pointer opacity-65 hover:opacity-100 hover:-translate-y-2 duration-300"/></a>
            </div>
